...
export const MovieDetail = () => {
  ...
  useEffect(()=>{
    async function fetchmovie() {
      const val = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=424d53be7956eb3b37badde5eb6fb5b0`);
  ...
  return (
    <main>
    <section className="flex justify-around flex-wrap py-5 relative">
